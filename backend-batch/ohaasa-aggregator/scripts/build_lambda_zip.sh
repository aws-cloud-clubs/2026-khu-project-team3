...
BUILD_DIR="${PROJECT_DIR}/.lambda_build/ohaasa"
...
cp -R "${PROJECT_DIR}/src/ohaasa_aggregator" "${BUILD_DIR}/ohaasa_aggregator"
...
echo "Lambda handler: ohaasa_aggregator.handlers.aggregator_handler.handler"
